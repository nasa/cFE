 ...
 * dictionary tool.
 */
#ifndef DEFAULT_CFE_TA_PLATFORM_CFG_H
#define DEFAULT_CFE_TA_PLATFORM_CFG_H

#include "cfe_ta_mission_cfg.h"
#include "cfe_ta_internal_cfg_values.h"

/**
 * \name TA Platform Configuration
 * \{
 */

/**
**  \brief Define TA Task Priority
**
**  \par Description:
...
/** \} */
#include "cfe_ta_internal_cfg.h"

#endif /* DEFAULT_CFE_TA_PLATFORM_CFG_H */
