...
**  \sa
*/
#define CFE_EVS_NOOP_CC CFE_EVS_CCVAL(NOOP)
...
*/
#define CFE_EVS_RESET_COUNTERS_CC CFE_EVS_CCVAL(RESET_COUNTERS)
...
*/
#define CFE_EVS_ENABLE_EVENT_TYPE_CC CFE_EVS_CCVAL(ENABLE_EVENT_TYPE)
...
**      #CFE_EVS_DISABLE_APP_EVENT_TYPE_CC, #CFE_EVS_ENABLE_APP_EVENTS_CC, #CFE_EVS_DISABLE_APP_EVENTS_CC
*/
#define CFE_EVS_DISABLE_EVENT_TYPE_CC CFE_EVS_CCVAL(DISABLE_EVENT_TYPE)
...
**  \sa
*/
#define CFE_EVS_SET_EVENT_FORMAT_MODE_CC CFE_EVS_CCVAL(SET_EVENT_FORMAT_MODE)
...
**      #CFE_EVS_DISABLE_APP_EVENT_TYPE_CC, #CFE_EVS_ENABLE_APP_EVENTS_CC, #CFE_EVS_DISABLE_APP_EVENTS_CC
*/
#define CFE_EVS_ENABLE_APP_EVENT_TYPE_CC CFE_EVS_CCVAL(ENABLE_APP_EVENT_TYPE)
...
*/
#define CFE_EVS_DISABLE_APP_EVENT_TYPE_CC CFE_EVS_CCVAL(DISABLE_APP_EVENT_TYPE)
...
*/
#define CFE_EVS_ENABLE_APP_EVENTS_CC CFE_EVS_CCVAL(ENABLE_APP_EVENTS)
...
*/
#define CFE_EVS_DISABLE_APP_EVENTS_CC CFE_EVS_CCVAL(DISABLE_APP_EVENTS)
...
*/
#define CFE_EVS_RESET_APP_COUNTER_CC CFE_EVS_CCVAL(RESET_APP_COUNTER)
...
*/
#define CFE_EVS_SET_FILTER_CC CFE_EVS_CCVAL(SET_FILTER)
...
*/
#define CFE_EVS_ENABLE_PORTS_CC CFE_EVS_CCVAL(ENABLE_PORTS)
...
*/
#define CFE_EVS_DISABLE_PORTS_CC CFE_EVS_CCVAL(DISABLE_PORTS)
...
*#CFE_EVS_DELETE_EVENT_FILTER_CC
*/
#define CFE_EVS_RESET_FILTER_CC CFE_EVS_CCVAL(RESET_FILTER)
...
*/
#define CFE_EVS_RESET_ALL_FILTERS_CC CFE_EVS_CCVAL(RESET_ALL_FILTERS)
...
*/
#define CFE_EVS_ADD_EVENT_FILTER_CC CFE_EVS_CCVAL(ADD_EVENT_FILTER)
...
*/
#define CFE_EVS_DELETE_EVENT_FILTER_CC CFE_EVS_CCVAL(DELETE_EVENT_FILTER)
...
*/
#define CFE_EVS_WRITE_APP_DATA_FILE_CC CFE_EVS_CCVAL(WRITE_APP_DATA_FILE)
...
*/
#define CFE_EVS_WRITE_LOG_DATA_FILE_CC CFE_EVS_CCVAL(WRITE_LOG_DATA_FILE)
...
*/
#define CFE_EVS_SET_LOG_MODE_CC CFE_EVS_CCVAL(SET_LOG_MODE)
...
**  \sa #CFE_EVS_WRITE_LOG_DATA_FILE_CC, #CFE_EVS_SET_LOG_MODE_CC
*/
#define CFE_EVS_CLEAR_LOG_CC CFE_EVS_CCVAL(CLEAR_LOG)
/** \} */
