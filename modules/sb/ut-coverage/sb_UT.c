...
void Test_TransmitMsg_NoSubscribers(void)
{
    ...
    CFE_UtAssert_SUCCESS(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, true));
...
void Test_TransmitMsg_MaxMsgSizePlusOne(void)
{
    ...
    UtAssert_INT32_EQ(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, true), CFE_SB_MSG_TOO_BIG);
...
void Test_TransmitMsg_SequenceCount(void)
{
    ...
    CFE_UtAssert_SETUP(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, true));
    ...
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetSize), &Size, sizeof(Size), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &Type, sizeof(Type), false);
    CFE_UtAssert_SUCCESS(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, false));
    ...
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetSize), &Size, sizeof(Size), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &Type, sizeof(Type), false);
    CFE_UtAssert_SETUP(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, true)); /* increment to 3 */
    ...
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetSize), &Size, sizeof(Size), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &Type, sizeof(Type), false);
    CFE_UtAssert_SETUP(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, true)); /* increment to 4 */
    UtAssert_INT32_EQ(SeqCnt, SeqCntExpected);
...
void Test_TransmitMsg_GetPoolBufErr(void)
{
    ...
    UtAssert_INT32_EQ(CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&TlmPkt, true), CFE_SB_BUF_ALOC_ERR);
...
void Test_TransmitMsgValidate_MaxMsgSizePlusOne(void)
{
    ...
    UtAssert_INT32_EQ(CFE_SB_TransmitMsgValidate((CFE_MSG_Message_t*)&TlmPkt, &MsgIdRtn, &SizeRtn, &RouteIdRtn),
                      CFE_SB_MSG_TOO_BIG);
...
void Test_TransmitMsgValidate_NoSubscribers(void)
{
    ...
    CFE_UtAssert_SUCCESS(CFE_SB_TransmitMsgValidate((CFE_MSG_Message_t*)&TlmPkt, &MsgIdRtn, &SizeRtn, &RouteIdRtn));
    CFE_UtAssert_MSGID_EQ(MsgIdRtn, MsgId);
    UtAssert_INT32_EQ(SizeRtn, Size);
...
void Test_CFE_SB_GetUserData(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&cmd_uint8), &(cmd_uint8.payload));
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&cmd_uint16), &(cmd_uint16.payload));
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&cmd_uint32), &(cmd_uint32.payload));
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&cmd_uint64), &(cmd_uint64.payload));

    /* Telemetry */
    type = CFE_MSG_Type_Tlm;
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&tlm_uint8), &(tlm_uint8.payload));
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&tlm_uint16), &(tlm_uint16.payload));
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&tlm_uint32), &(tlm_uint32.payload));
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetHasSecondaryHeader), &hassec, sizeof(hassec), false);
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetType), &type, sizeof(type), false);
    UtAssert_ADDRESS_EQ(CFE_SB_GetUserData((CFE_MSG_Message_t*)&tlm_uint64), &(tlm_uint64.payload));
