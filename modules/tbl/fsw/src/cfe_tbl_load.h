 ...
 * \param[out]   FileHeader        Pointer to buffer that will hold header data
 *
 ...
 *
 * \param[inout] Txn               Pointer to transaction object
 * \param[in]    FileHeader        Pointer to buffer that holds header data
 *
 * \returns CFE Status Code
 * \retval #CFE_SUCCESS                     \copydoc CFE_SUCCESS
 */
CFE_Status_t CFE_TBL_ValidateFileIsLoadable(CFE_TBL_TxnState_t *Txn, const CFE_TBL_File_Hdr_t *FileHeader);
