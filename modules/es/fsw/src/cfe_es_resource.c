...
CFE_ES_AppRecord_t *CFE_ES_LocateAppRecordByName(const char *Name)
{
    ...
    */
    ...
    while (true)
    {
        ...
        if (CFE_ES_AppRecordIsUsed(AppRecPtr) && strncmp(Name, CFE_ES_AppRecordGetName(AppRecPtr), CFE_MISSION_MAX_API_LEN) == 0)
        {
            break;
        }
...
CFE_ES_LibRecord_t *CFE_ES_LocateLibRecordByName(const char *Name)
{
    ...
    */
    ...
    while (true)
    {
        ...
        if (CFE_ES_LibRecordIsUsed(LibRecPtr) && strncmp(Name, CFE_ES_LibRecordGetName(LibRecPtr), CFE_MISSION_MAX_API_LEN) == 0)
        {
            break;
        }
...
CFE_ES_GenCounterRecord_t *CFE_ES_LocateCounterRecordByName(const char *Name)
{
    ...
    */
    ...
    while (true)
    {
        ...
        if (CFE_ES_CounterRecordIsUsed(CounterRecPtr) && strncmp(Name, CFE_ES_CounterRecordGetName(CounterRecPtr), OS_MAX_API_NAME) == 0)
        {
            break;
        }
