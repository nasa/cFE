 ...
 * dictionary tool.
 */
#ifndef DEFAULT_CFE_TIME_INTERNAL_CFG_H
#define DEFAULT_CFE_TIME_INTERNAL_CFG_H

/* Use the default configuration value for all */
#define CFE_PLATFORM_TIME_CFGVAL(x) DEFAULT_CFE_PLATFORM_TIME_##x

/* This define does not really belong here, but it is the only place for it
 * for now until the refs can be updated or it can be removed entirely */
