...
*/
    ...
    */
    CFE_MSG_Init((CFE_MSG_Message_t*)&CFE_TIME_Global.HkPacket, CFE_SB_ValueToMsgId(CFE_TIME_HK_TLM_MID),
                 sizeof(CFE_TIME_Global.HkPacket));

    /*
    ** Initialize diagnostic packet (clear user data area)...
    */
    CFE_MSG_Init((CFE_MSG_Message_t*)&CFE_TIME_Global.DiagPacket, CFE_SB_ValueToMsgId(CFE_TIME_DIAG_TLM_MID),
                 sizeof(CFE_TIME_Global.DiagPacket));

    /*
    ** Initialize "time at the tone" signal command packet...
    */
    CFE_MSG_Init((CFE_MSG_Message_t*)&CFE_TIME_Global.ToneSignalCmd, CFE_SB_ValueToMsgId(CFE_TIME_TONE_CMD_MID),
...
*/
    ...
    CFE_MSG_Init((CFE_MSG_Message_t*)&CFE_TIME_Global.ToneDataCmd, CFE_SB_ValueToMsgId(CFE_TIME_DATA_CMD_MID),
    ...
    */
    ...
    CFE_MSG_Init((CFE_MSG_Message_t*)&CFE_TIME_Global.ToneSendCmd, CFE_SB_ValueToMsgId(CFE_TIME_SEND_CMD_MID),
    ...
    */
    CFE_MSG_Init((CFE_MSG_Message_t*)&CFE_TIME_Global.Local1HzCmd, CFE_SB_ValueToMsgId(CFE_TIME_1HZ_CMD_MID),
