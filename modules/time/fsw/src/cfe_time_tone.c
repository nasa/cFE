...
*/
    ...
    */
    CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&CFE_TIME_Global.ToneDataCmd, false);
...
void CFE_TIME_Tone1HzTask(void)
{
    ...
    while (true)
    {
        ...
        */
        CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&CFE_TIME_Global.ToneSignalCmd, false);
        ...
        */
        CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&CFE_TIME_Global.ToneSendCmd, false);
#endif
...
void CFE_TIME_Local1HzTask(void)
{
    ...
    while (true)
    {
        ...
        */
        CFE_SB_TransmitMsg((CFE_MSG_Message_t*)&CFE_TIME_Global.Local1HzCmd, false);
