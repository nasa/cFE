...
#define CFE_TBL_COMMAND_ENTRY(ccode,paramtype,handlerfunc) \
        { CFE_SB_MSGID_WRAP_VALUE(CFE_TBL_CMD_MID_VALUE), ccode, sizeof(paramtype), (CFE_TBL_MsgProcFuncPtr_t)handlerfunc, CFE_TBL_CMD_MSGTYPE }
...
const CFE_TBL_CmdHandlerTblRec_t CFE_TBL_CmdHandlerTbl[] =
{
        ...
        CFE_TBL_MESSAGE_ENTRY(CFE_SB_MSGID_WRAP_VALUE(CFE_TBL_SEND_HK_MID_VALUE),  CFE_TBL_HousekeepingCmd),
