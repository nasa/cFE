...
typedef struct CFE_ES_GenPoolBD
{
  ...
  CFE_ES_MemOffset_t   ActualSize;  /**< The actual requested size of the block */
  CFE_ES_MemOffset_t   NextOffset;  /**< The offset of the next descriptor in the free stack */
} CFE_ES_GenPoolBD_t;
...
typedef struct CFE_ES_GenPoolBucket
{
    ...
    CFE_ES_MemOffset_t FirstOffset; /**< Top of the "free stack" of buffers which have been returned */
...
{
    CFE_ES_MemOffset_t PoolTotalSize;   /**< Total size of the pool area, in bytes */
    CFE_ES_MemOffset_t PoolMaxOffset;   /**< End offset (position) of the pool */
    CFE_ES_MemOffset_t AlignMask;       /**< Alignment mask applied to all new allocations */
    CFE_ES_MemOffset_t TailPosition;    /**< Current high watermark of the pool, end of last allocation */
