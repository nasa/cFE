...
{
        .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_SEND_HK_MID_VALUE)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_TONE_CMD =
{
        .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_TONE_CMD_MID_VALUE)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_DATA_CMD =
{
        .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_DATA_CMD_MID_VALUE)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_1HZ_CMD =
{
        .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_1HZ_CMD_MID_VALUE)
};

#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_SEND_CMD =
{
        .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_SEND_CMD_MID_VALUE)
};
#endif

static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_NOOP_CC =
{
        .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_CMD_MID_VALUE),
...
void Test_PipeCmds(void)
{
    ...
    {
            .MsgId = CFE_SB_MSGID_WRAP_VALUE(CFE_TIME_HK_TLM_MID_VALUE)
    };
