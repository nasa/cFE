proc cfe_b3p1_tbl_integration_cpu2
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;	   Also note that this procedure is written for CPU2.
...
ut_setupevt "SCX", "CPU2", "CFE_EVS", 20, "DEBUG"
                                                                                
ut_sendcmd "SCX_CPU2_EVS_ENAEVENTTYPE DEBUG"

if (UT_SC_Status = UT_SC_Success) then
  write "<*> Success: Debug events have been enabled."
  if (SCX_CPU2_num_found_messages = 1) then
    Write "<*> Success: Event Msg ",SCX_CPU2_find_evs_eventid," Found!"
  else
...
write ";*********************************************************************"
write "BEFORE loading, there are " & SCX_CPU2_TBL_NUMTABLES & " tables registered"

start tst_tbl_apps_start_cpu2 ("1.2")

Write "AFTER loading, there are " & SCX_CPU2_TBL_NUMTABLES & " tables registered"
...
if (p@SCX_CPU2_RF[4].SCX_CPU2_TBL_LOADEDONCE <> "TRUE") then
  Write "Loading the file that contains the default values for table 4."
  write "FTP the file to FSW (file = deflt_tbl_04)"
  s proc_ftp ("RAM:","deflt_tbl_04","deflt_tbl_04","CPU2","P")
  wait 10

  ut_setupevt "SCX", "CPU2", "CFE_TBL", 35, "DEBUG"

  write "Sending the TST_TBL_LOADFILE command "
  /SCX_CPU2_TST_TBL_LOADFILE
  ...
  if (SCX_CPU2_num_found_messages = 1) then
    ...
    Write "<!> Error: Event Msg ",SCX_CPU2_evs_eventid," received for Load File command. Expected Load Success Event (35)."
    table4_initialized = 0
  endif
elseif (p@SCX_CPU2_RF[4].SCX_CPU2_TBL_LOADEDONCE = "TRUE") then
  table4_initialized = 1
endif 
...
page SCX_CPU2_TBL_REGISTRY

ut_setupevt "SCX", "CPU2", "CFE_TBL", 15, "DEBUG"

s get_file_to_cvt ("RAM:", "tbl_reg.log", "scx_cpu2_tbl_reg.log", "CPU2")
...
if (table4_initialized = 1) then
  ...
  wait until (p@SCX_CPU2_RF[4].SCX_CPU2_TBL_LOADEDONCE = "TRUE")
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 10, "INFO"

ut_sendcmd "SCX_CPU2_TBL_NOOP"
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 51, "ERROR"

error_cmd_ctr = SCX_CPU2_TBL_CMDEC + 1

ut_sendrawcmd "SCX_CPU2_TST_TBL", "1824c0000001aa"

ut_tlmwait SCX_CPU2_TBL_CMDEC, {error_cmd_ctr} 
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 11, "DEBUG"

ut_sendcmd "SCX_CPU2_TBL_RESETCTRS"

; Check if the CMDPC counter reset
ut_tlmwait SCX_CPU2_TBL_CMDPC, 0
...
ut_tlmwait SCX_CPU2_TBL_CMDEC, 0
if (UT_TW_Status = UT_Success) then
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 14, "INFO"

s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","A","tbl_01_active","CPU2","0FC0")

if (SCX_CPU2_num_found_messages = 1) then
  write "<*> Success: Event Msg ",SCX_CPU2_find_evs_eventid," Found!"
else
  if (SCX_CPU2_evs_eventid = 13) then
    write "<*> Success: Expected Event Msg 14 but rcv'd Event Msg ",SCX_CPU2_evs_eventid," which means the dump file was overwritten."
  else
...
write "    1st byte = ", SCX_CPU2_TST_TBL_TABLE1.FIRSTBYTE
write "    2nd byte = ", SCX_CPU2_TST_TBL_TABLE1.SECONDBYTE
write "    3rd byte = ", SCX_CPU2_TST_TBL_TABLE1.THIRDBYTE
write "    4th byte = ", SCX_CPU2_TST_TBL_TABLE1.FOURTHBYTE
write "    5th byte = ", SCX_CPU2_TST_TBL_TABLE1.FIFTHBYTE
write "    6th byte = ", SCX_CPU2_TST_TBL_TABLE1.SIXTHBYTE
write "    7th byte = ", SCX_CPU2_TST_TBL_TABLE1.SEVENTHBYTE
write "    8th byte = ", SCX_CPU2_TST_TBL_TABLE1.EIGHTHBYTE
...
write ";*********************************************************************"
success_cmd_ctr = SCX_CPU2_TBL_CMDPC + 1

ut_setupevt "SCX", "CPU2", "CFE_TBL", 12, "INFO"

; Load the file dumped in the previous step in order to
; populate the inactive buffer
start load_table ("table_01_active", "CPU2")

ut_tlmwait SCX_CPU2_TBL_CMDPC, {success_cmd_ctr} 
...
wait until (SCX_CPU2_RF[1].SCX_CPU2_TBL_LOADINPROGRESS <> -1) 
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","I","tbl_01_inactive","CPU2","0FC0")
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_02","I","tbl_02_inactive","CPU2","0FC1")
...
write "    1st byte = ", SCX_CPU2_TST_TBL_TABLE2.FIRSTBYTE
write "    2nd byte = ", SCX_CPU2_TST_TBL_TABLE2.SECONDBYTE
write "    3rd byte = ", SCX_CPU2_TST_TBL_TABLE2.THIRDBYTE
write "    4th byte = ", SCX_CPU2_TST_TBL_TABLE2.FOURTHBYTE
write "    5th byte = ", SCX_CPU2_TST_TBL_TABLE2.FIFTHBYTE
write "    6th byte = ", SCX_CPU2_TST_TBL_TABLE2.SIXTHBYTE
write "    7th byte = ", SCX_CPU2_TST_TBL_TABLE2.SEVENTHBYTE
write "    8th byte = ", SCX_CPU2_TST_TBL_TABLE2.EIGHTHBYTE
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_02","A","tbl_02_active","CPU2","0FC1")
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_03","A","tbl_03_active","CPU2","0FC2")
...
write "    1st byte = ", SCX_CPU2_TST_TBL_TABLE3.FIRSTBYTE
write "    2nd byte = ", SCX_CPU2_TST_TBL_TABLE3.SECONDBYTE
write "    3rd byte = ", SCX_CPU2_TST_TBL_TABLE3.THIRDBYTE
write "    4th byte = ", SCX_CPU2_TST_TBL_TABLE3.FOURTHBYTE
write "    5th byte = ", SCX_CPU2_TST_TBL_TABLE3.FIFTHBYTE
write "    6th byte = ", SCX_CPU2_TST_TBL_TABLE3.SIXTHBYTE
write "    7th byte = ", SCX_CPU2_TST_TBL_TABLE3.SEVENTHBYTE
write "    8th byte = ", SCX_CPU2_TST_TBL_TABLE3.EIGHTHBYTE
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_04","A","tbl_04_active","CPU2","0FC3")
...
write "    1st byte = ", SCX_CPU2_TST_TBL_TABLE4.FIRSTBYTE
write "    2nd byte = ", SCX_CPU2_TST_TBL_TABLE4.SECONDBYTE
write "    3rd byte = ", SCX_CPU2_TST_TBL_TABLE4.THIRDBYTE
write "    4th byte = ", SCX_CPU2_TST_TBL_TABLE4.FOURTHBYTE
write "    5th byte = ", SCX_CPU2_TST_TBL_TABLE4.FIFTHBYTE
write "    6th byte = ", SCX_CPU2_TST_TBL_TABLE4.SIXTHBYTE
write "    7th byte = ", SCX_CPU2_TST_TBL_TABLE4.SEVENTHBYTE
write "    8th byte = ", SCX_CPU2_TST_TBL_TABLE4.EIGHTHBYTE

write ";*********************************************************************"
write "; Step 4.8:  Abort the Load for table #1 so that the steps below work."
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 21, "INFO"

ut_sendcmd "SCX_CPU2_TBL_LOAD_ABORT ABTABLENAME=""TST_TBL.deflt_tbl_01"""
if (UT_SC_Status = UT_SC_Success) then
...
SCX_CPU2_TST_TBL_TABLE1.FIRSTBYTE = x'61'
SCX_CPU2_TST_TBL_TABLE1.SECONDBYTE = 0
SCX_CPU2_TST_TBL_TABLE1.THIRDBYTE = x'61'
SCX_CPU2_TST_TBL_TABLE1.FOURTHBYTE = 0
SCX_CPU2_TST_TBL_TABLE1.FIFTHBYTE = x'61'
SCX_CPU2_TST_TBL_TABLE1.SIXTHBYTE = 0
SCX_CPU2_TST_TBL_TABLE1.SEVENTHBYTE = x'63'
SCX_CPU2_TST_TBL_TABLE1.EIGHTHBYTE = 0

s write_file ("CPU2",4032,"Full Table load", "tbl_01_valid_load","TST_TBL.deflt_tbl_01", "SCX_CPU2_TST_TBL_TABLE1.FIRSTBYTE", "SCX_CPU2_TST_TBL_TABLE1.EIGHTHBYTE")

wait 5

success_cmd_ctr = SCX_CPU2_TBL_CMDPC + 1
num_free_buffers = SCX_CPU2_TBL_numFreeshrBuf - 1

ut_setupevt "SCX", "CPU2", "CFE_TBL", 12, "INFO"

start load_table ("tbl_01_valid_load", "CPU2")
...
ut_tlmwait SCX_CPU2_TBL_NumFreeshrBuf, {num_free_buffers} 

if (UT_TW_Status = UT_Success) then
  write "<*> Success: Free shared buffers = ", num_free_buffers
else
  write "<!> Error: Expected ", num_free_buffers, " counter = ", SCX_CPU2_TBL_NumFreeshrBuf
endif
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","ACTIVE","tbl_01_52active","CPU2","0FC0")
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 16, "DEBUG"

ut_sendcmd "SCX_CPU2_TBL_VALIDATE INACTIVE VTABLENAME=""TST_TBL.deflt_tbl_01"""
if (UT_SC_Status = UT_SC_Success) then
...
if (SCX_CPU2_EVS_EVENTID <> 36) then
  ut_setupevt "SCX", "CPU2", "CFE_TBL", 36, "INFO"
  ...
  if (SCX_CPU2_num_found_messages = 1) then
    ...
    write "<*> Success: Inactive Table 1 validated successfully."
    write "<*> Success: Event Msg ",SCX_CPU2_evs_eventid," Found!"
endif
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 17, "DEBUG"

ut_sendcmd "SCX_CPU2_TBL_ACTIVATE ATABLENAME=""TST_TBL.deflt_tbl_01"""
if (UT_SC_Status = UT_SC_Success) then
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","ACTIVE","tbl_01_56active","CPU2","0FC0")
...
if (SCX_CPU2_TBL_NumFreeshrBuf = 4) then
  write "<*> Success: There are 4 available shared buffers."
else
  write "<!> Error: There are ", SCX_CPU2_TBL_NumFreeshrBuf, " available shared buffers."
endif
...
if (SCX_CPU2_RF[1].SCX_CPU2_TBL_LASTFILELOADED = "RAM:/tbl_01_valid_load") then
  write "<*> Success: The correct file was loaded into Table #1."
else
  write "<!> Error: Table #1 was loaded with ", SCX_CPU2_RF[1].SCX_CPU2_TBL_LASTFILELOADED
endif
...
SCX_CPU2_TST_TBL_TABLE3.THIRDBYTE = x'63'
SCX_CPU2_TST_TBL_TABLE3.FOURTHBYTE = x'36'

; write new load file
s write_file ("CPU2",4034,"Partial Table load", "tbl_03_partial_load","TST_TBL.deflt_tbl_03", "SCX_CPU2_TST_TBL_TABLE3.THIRDBYTE", "SCX_CPU2_TST_TBL_TABLE3.FOURTHBYTE")

; Load Table #3 with the file written above
start load_table ("tbl_03_partial_load", "CPU2")
...
ut_sendcmd "SCX_CPU2_TBL_ACTIVATE ATABLENAME=""TST_TBL.deflt_tbl_03"""
...
wait until (p@SCX_CPU2_RF[3].SCX_CPU2_TBL_LOADPENDING = "FALSE")

; verify that the loaded file is now being used 
if (SCX_CPU2_RF[3].SCX_CPU2_TBL_LASTFILELOADED = "RAM:/tbl_03_partial_load") then
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","ACTIVE","tbl_01_61active","CPU2","0FC0")
...
SCX_CPU2_TST_TBL_TABLE1.FIRSTBYTE = x'36'

; Write the file
s write_file ("CPU2",4032,"Invalid Table load", "tbl_01_invalid","TST_TBL.deflt_tbl_01", "SCX_CPU2_TST_TBL_TABLE1.FIRSTBYTE", "SCX_CPU2_TST_TBL_TABLE1.EIGHTHBYTE")
...
start load_table ("tbl_01_invalid", "CPU2")
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","INACTIVE","tbl_01_61inactive","CPU2","0FC0")

; Check if the first byte is what we set it to
if (SCX_CPU2_TST_TBL_TABLE1.FIRSTBYTE = x'36') then
...
if (SCX_CPU2_EVS_EVENTID <> 96) then
  ut_setupevt "SCX", "CPU2", "CFE_TBL", 96, "INFO"
...
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_02","ACTIVE","tbl_02_63active","CPU2","0FC1")
...
success_cmd_ctr = SCX_CPU2_TBL_CMDPC + 1
error_cmd_ctr = SCX_CPU2_TBL_CMDEC
num_free_buffers = SCX_CPU2_TBL_numFreeshrBuf - 1
table2_loaded = 0
wait 3 
...
start load_table ("tbl_02_63active", "CPU2")
...
if (table2_loaded = 1) then
  ...
  ut_sendcmd "SCX_CPU2_TBL_VALIDATE INACTIVE VTABLENAME=""TST_TBL.deflt_tbl_02"""
  if (UT_SC_Status = UT_SC_Success) then
...
ut_sendcmd "SCX_CPU2_TBL_VALIDATE ACTIVE VTABLENAME=""TST_TBL.deflt_tbl_01"""
if (UT_SC_Status = UT_SC_Success) then
...
ut_sendcmd "SCX_CPU2_TBL_VALIDATE ACTIVE VTABLENAME=""TST_TBL.deflt_tbl_02"""
if (UT_SC_Status = UT_SC_Success) then
...
wait until (p@SCX_CPU2_RF[1].SCX_CPU2_TBL_LOADPENDING = "FALSE")

; verify that the loaded file is now being used 
if (SCX_CPU2_RF[1].SCX_CPU2_TBL_LASTFILELOADED = "RAM:/tbl_01_invalid") then
...
if (table2_loaded = 1) then
  ...
  ut_sendcmd "SCX_CPU2_TBL_ACTIVATE ATABLENAME=""TST_TBL.deflt_tbl_02"""
...
ut_sendcmd "SCX_CPU2_TBL_WRITEREG2FILE DUMPFILENAME"
...
if (SCX_CPU2_RF[1].SCX_CPU2_TBL_TABLENAME = "TST_TBL.deflt_tbl_01" AND  ;;
    SCX_CPU2_RF[2].SCX_CPU2_TBL_TABLENAME = "TST_TBL.deflt_tbl_02" AND  ;;
    SCX_CPU2_RF[3].SCX_CPU2_TBL_TABLENAME = "TST_TBL.deflt_tbl_03" AND  ;;
    SCX_CPU2_RF[4].SCX_CPU2_TBL_TABLENAME = "TST_TBL.deflt_tbl_04") then
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 18, "DEBUG"

ut_sendcmd "SCX_CPU2_TBL_TLM_REG RTTABLENAME=""TST_TBL.deflt_tbl_02"""
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 20, "INFO"

ut_sendcmd "SCX_CPU2_TBL_MOD_DONLY DUMP_ONLY RMTABLENAME=""TST_TBL.deflt_tbl_01"""
...
wait until (p@SCX_CPU2_RF[1].SCX_CPU2_TBL_DUMPONLY = "TRUE")
...
; Dump the Active table for Table #1
s get_tbl_to_cvt ("RAM:","TST_TBL.deflt_tbl_01","ACTIVE","tbl_01_10_2active","CPU2","0FC0")
...
start load_table ("tbl_01_10_2active", "CPU2")
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 19, "INFO"

ut_sendcmd "SCX_CPU2_TBL_MOD_DONLY LOAD_DUMP RMTABLENAME=""TST_TBL.deflt_tbl_01"""
...
wait until (p@SCX_CPU2_RF[1].SCX_CPU2_TBL_DUMPONLY = "FALSE")
...
wait until (p@SCX_CPU2_RF[1].SCX_CPU2_TBL_LOADINPROGRESS <> -1)
write "<*> Success: Load In Progress field changed"
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "CFE_TBL", 66, "ERROR"

ut_sendcmd "SCX_CPU2_TBL_DUMP INACTIVE DTABLENAME=""TST_TBL.deflt_tbl_01"" DFILENAME=""RAM:/tbl_01_inactive"""
...
if (SCX_CPU2_TBL_NumFreeshrBuf = 4) then
  ...
  write "<!> Error: There are ", SCX_CPU2_TBL_NumFreeshrBuf, " available shared buffers. Expected 4 buffers."
endif
...
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "TST_TBL2", 25, "INFO"

/SCX_CPU2_TST_TBL2_SHARETBL
...
write "; Table #4."
write ";*********************************************************************"
ut_setupevt "SCX", "CPU2", "TST_TBL2", 17, "INFO"

/SCX_CPU2_TST_TBL2_GETTBLADDR
...
start load_table ("deflt_tbl_04_full", "CPU2")
...
ut_sendcmd "SCX_CPU2_TBL_ACTIVATE ATABLENAME=""TST_TBL.deflt_tbl_04"""
if (UT_SC_Status = UT_SC_Success) then
